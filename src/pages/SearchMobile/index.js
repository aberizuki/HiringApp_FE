...
function SearcMobile() {
    ...
    function ListSort() {
        ...
        return (
            <div
                className="absolute bg-[#0000004D] top-[0] w-full h-[100vh] flex items-center justify-center ">
    ...
    return (
        <div className="">
            <div className="flex h-[100vh] w-full justify-between  px-5 mt-16 rigth-0">
                <div className="w-[80%] flex h-[50px] bg-white items-center rounded shadow-lg">
                    <img
                        ...
                        alt=""/>
                    <input placeholder="Android developer" className="py-3 text-bold"/>
                </div>
                <div
