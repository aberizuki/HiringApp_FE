            ...
            <section className="mb-5">
                <div className="lg:flex justify-center">
                    <div className="m-10 lg:m-[50px] lg:ml-[100px]">
                        ...
                        <div className="mb-5">
                            <button
                                className="bg-[#5E50A1] hover:bg-[#5E50A1] text-white font-bold py-2 px-4 rounded">
                                Start from now
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center w-[100%] h-[100%] p-10">
                        <div
                            ...
                            <div className="flex m-5">
                                <div>
                                    <button
                                        className="bg-[#FFFFFF] hover:bg-[#5E50A1] text-[#5E50A1] font-semibold hover:text-white py-2 px-4 border border-[#5E50A1] hover:border-transparent rounded mr-5">
                                        Start from now
                                    </button>
                                </div>
                            </div>
