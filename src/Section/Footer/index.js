            ...
            <div className="container text-lg text-white">
                <div className="flex flex-col pt-[70px] pb-10">
                    <div className="w-[30%]">
                        ...
                        src={require("src/assets/peworld-logo-wait.png")} alt="logo"/>
                        <p className="my-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In euismod ipsum et dui rhoncus auctor.</p>
                    </div>
