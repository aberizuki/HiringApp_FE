                            ...
                            <div className="flex flex-col ">
                                ...
                                <div className="mb-16">
                                    ...
                                    <div className="skill">
                                        ...
                                        <button className="btn-secondary px-6 py-1 mr-3 my-3">PHP</button>
                                        <button className="btn-secondary px-6 py-1 mr-3 my-3">HTML</button>
                                        <button className="btn-secondary px-6 py-1 mr-3 my-3">LARAVEL</button>
                                        <button className="btn-secondary px-6 py-1 mr-3 my-3">KOTLIN</button>
                                        <button className="btn-secondary px-6 py-1 mr-3 my-3">C++</button>
                                        <button className="btn-secondary px-6 py-1 mr-3 my-3">SWIFT</button>
                                    </div>
                                </div>
                                <div>
                                    <div className="flex w-full my-4">
                                        <img
                                            className="w-[24px] mr-10"
