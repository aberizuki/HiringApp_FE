  ...
  function CardPengalamanKerja() {
    return data.map(() => (
      <div className="w-full flex py-10 border-b-[2px]">
        ...
        <div className="w-[75%]">
          <p className="text-[#1F2A36] text-lg font-semibold text-[#1F2A36] ">
            Engineer
          </p>
          <p className="text-[#1F2A36] text-lg font-normal text-[#46505C] mt-3">
            Tokopedia
          </p>
          <p className="text-[#1F2A36] text-base text-[#9EA0A5] mt-3 ">
            July 2019 - January 2020 6 months
          </p>
          <p className="text-[#1F2A36] text-sm leading-6 mt-4">
  ...
  return (
    <div className="flex ">
      <div className="w-full bg-white rounded-lg px-5 py-5 mb-10 ">
        <div className="card-profil flex-col justify-center items-center py-10">
          <div className="flex flex-col ">
            <div className="flex w-full md:w-[50%] text-base md:text-lg">
              <p
                onClick={() => setShow(true)}
                className={
                  show
                    ? "w-1/2 border-b-[4px] pb-5 border-[#5E50A1] mr-3"
                    : "w-1/2 text-[#9EA0A5] mr-3"
                }
              >
                Portofolio
              </p>
              <p
                ...
                className={
                  !show
                    ? "w-1/2 border-b-[4px] pb-5 border-[#5E50A1]"
                    : "w-1/2 text-[#9EA0A5]"
                }
              >
                Pengalaman kerja
            ...
            <div className=" my-5 flex  w-full flex-wrap ">
              {show ? (
                data.map(() => (
                  <div className="md:w-[47%] my-5 md:mx-[1%] lg:mx-[1%] lg:w-[23%] md:flex md:flex-col md:items-center">
                    <img
                      className="w-full  my-5 "
                      src={require("src/assets/Rectangle 637.webp")}
                      alt="smhfbdhf"
                    />
                    <p className="hidden lg:flex lg:text-[#1F2A36] lg:text-sm ">
                      Remainder app
                    </p>
                  </div>
                ))
